...
const INJECTED_STYLES = `
  ...
  .film-grain {
      display: none; /* Hidden on mobile to prevent massive lag */
  }
  ...
  .premium-depth-card {
      ...
      box-shadow: 0 20px 40px -10px rgba(0, 0, 0, 0.8), inset 0 1px 1px rgba(255, 255, 255, 0.1);
  ...
  .iphone-bezel {
      ...
      box-shadow: inset 0 0 0 2px #52525B, inset 0 0 0 5px #000, 0 20px 40px -10px rgba(0,0,0,0.8);
...
export function CinematicHero({ 
  ...
  features = ["Android Applications", "Cross-Platform Apps", "Business Apps", "E-Commerce Apps"],
  className, 
  ...props 
}: CinematicHeroProps) {
  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      gsap.set(".text-track", { autoAlpha: 0, y: 60, scale: 0.85, filter: isMobile ? "none" : "blur(20px)", rotationX: -20 });
      gsap.set(".text-days", { autoAlpha: 1, clipPath: "inset(0 100% 0 0)" });
      gsap.set(".main-card", { y: window.innerHeight + 200, autoAlpha: 1 });
      gsap.set([".card-left-text", ".card-right-text", ".mockup-scroll-wrapper", ".floating-badge", ".phone-widget"], { autoAlpha: 0 });
      gsap.set(".cta-wrapper", { autoAlpha: 0, scale: 0.8, filter: isMobile ? "none" : "blur(30px)" });
      ...
      scrollTl
        .to([".hero-text-wrapper", ".bg-grid-theme"], { scale: 1.15, filter: isMobile ? "none" : "blur(20px)", opacity: 0.2, ease: "power2.inOut", duration: 2 }, 0)
        .to(".main-card", { y: 0, ease: "power3.inOut", duration: 2 }, 0);
        
      if (!isMobile) {
        scrollTl.to(".main-card", { width: "100%", height: "100%", borderRadius: "0px", ease: "power3.inOut", duration: 1.5 });
      } else {
        scrollTl.to(".main-card", { width: "100%", borderRadius: "0px", ease: "power3.inOut", duration: 1.5 });
      }

      scrollTl
        .fromTo(".mockup-scroll-wrapper",
          { y: 300, z: -500, rotationX: isMobile ? 15 : 50, rotationY: isMobile ? -10 : -30, autoAlpha: 0, scale: 0.6 },
        ...
        .to(".cta-wrapper", { scale: 1, filter: isMobile ? "none" : "blur(0px)", ease: "expo.inOut", duration: 1.8 }, "pullback")
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-20 flex items-center justify-center pointer-events-none" style={{ perspective: "1500px" }}>
        <div
          ref={mainCardRef}
          className="main-card premium-depth-card relative overflow-hidden gsap-reveal flex items-center justify-center pointer-events-auto w-[92vw] md:w-[85vw] h-auto min-h-[92vh] lg:h-[85vh] lg:min-h-0 rounded-[32px] md:rounded-[40px]"
        >
          <div className="card-sheen" aria-hidden="true" />

          {/* DYNAMIC RESPONSIVE GRID: Flex-col on mobile to force order, Grid on desktop */}
          <div className="relative w-full h-full max-w-7xl mx-auto px-4 lg:px-12 flex flex-col justify-center lg:grid lg:grid-cols-3 items-center gap-8 lg:gap-8 z-10 py-10 lg:py-0">
            ...
            <div className="mockup-scroll-wrapper order-2 lg:order-2 relative w-full h-[380px] lg:h-[600px] flex items-center justify-center z-10" style={{ perspective: "1000px" }}>
              ...
              <div className="relative w-full h-full flex items-center justify-center transform scale-[0.65] md:scale-85 lg:scale-100">
                      ...
                      <div className="space-y-3">
                        <div className="phone-widget widget-depth rounded-2xl p-3 flex items-center">
                          ...
                          <div className="flex-1">
                            <p className="text-white text-[11px] font-bold leading-tight">{features[0]}</p>
                            <p className="text-blue-200/50 text-[9px] mt-0.5">Optimized</p>
                          </div>
                        </div>
                        <div className="phone-widget widget-depth rounded-2xl p-3 flex items-center">
                          ...
                          <div className="flex-1">
                            <p className="text-white text-[11px] font-bold leading-tight">{features[1]}</p>
                            <p className="text-emerald-200/50 text-[9px] mt-0.5">Seamless</p>
                          </div>
                        </div>
                      </div>
                ...
                <div className="floating-badge absolute flex top-6 lg:top-12 left-[-15px] lg:left-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">{features[2]}</p>
                    <p className="text-blue-200/50 text-[10px] lg:text-xs font-medium">Enterprise Grade</p>
                  </div>
                </div>
                ...
                <div className="floating-badge absolute flex bottom-12 lg:bottom-20 right-[-15px] lg:right-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">{features[3]}</p>
                    <p className="text-indigo-200/50 text-[10px] lg:text-xs font-medium">High Conversion</p>
                  </div>
                </div>
            ...
            <div className="card-left-text gsap-reveal order-3 lg:order-1 flex flex-col justify-center text-center lg:text-left z-20 w-full lg:max-w-none px-0 sm:px-4 lg:px-0">
              <h3 className="text-white text-2xl md:text-3xl lg:text-4xl font-bold mb-3 lg:mb-5 tracking-tight">
                {cardHeading}
              </h3>
              <p className="text-blue-100/70 text-sm md:text-base lg:text-lg font-normal leading-relaxed mx-auto lg:mx-0 max-w-sm lg:max-w-none mb-6">
                {cardDescription}
              </p>
              
              {features && features.length > 0 && (
                <div className="hidden sm:block mt-4 text-left w-full sm:mx-auto sm:max-w-sm lg:mx-0 lg:max-w-none bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-5 shadow-xl">
                  <h4 className="text-white text-lg font-bold mb-4 tracking-tight flex items-center">
                  ...
                  <ul className="space-y-3">
                    {features.map((feature, i) => (
                      <li key={i} className="flex items-start text-blue-100/90 text-sm font-medium">
                        <div className="w-1.5 h-1.5 rounded-full bg-blue-500 mr-3 mt-1.5 flex-shrink-0 shadow-[0_0_8px_rgba(59,130,246,0.8)]" />
                        <span className="flex-1 leading-tight text-left">{feature}</span>
                      </li>
                    ))}
                  </ul>
                </div>
