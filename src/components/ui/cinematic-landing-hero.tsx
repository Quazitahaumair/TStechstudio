...
export function CinematicHero({
  ...
  cardDescription = (
    <>
      <span className="text-white font-semibold">Sobers</span> empowers sponsors and sponsees in
      12-step recovery programs with structured accountability, precise sobriety tracking, and
  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      scrollTl
        ...
        .to(
          ".cta-wrapper",
          { scale: 1, filter: isMobile ? "none" : "blur(0px)", ease: "expo.inOut", duration: 1.8 },
          "pullback",
        )
              ...
              <div className="relative w-full h-full flex items-center justify-center transform scale-[0.65] md:scale-85 lg:scale-100">
                    ...
                    <div className="relative w-full h-full pt-12 px-5 pb-8 flex flex-col">
                      ...
                      <div className="phone-widget relative w-44 h-44 mx-auto flex items-center justify-center mb-8 drop-shadow-[0_15px_25px_rgba(0,0,0,0.8)]">
                        ...
                        <div className="text-center z-10 flex flex-col items-center">
                          ...
                          <span className="text-[8px] text-blue-200/50 uppercase tracking-[0.1em] font-bold mt-0.5">
                            {metricLabel}
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="space-y-3">
                        <div className="phone-widget widget-depth rounded-2xl p-3 flex items-center">
                          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-500/20 to-blue-600/5 flex items-center justify-center mr-3 border border-blue-400/20 shadow-inner">
                            <svg
                              className="w-4 h-4 text-blue-400 drop-shadow-md"
                              fill="none"
                              stroke="currentColor"
                              viewBox="0 0 24 24"
                              aria-hidden="true"
                ...
                <div className="floating-badge absolute flex bottom-12 lg:bottom-20 right-[-15px] lg:right-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    ...
                    <p className="text-indigo-200/50 text-[10px] lg:text-xs font-medium">
                      High Conversion
                    </p>
                  </div>
                </div>
