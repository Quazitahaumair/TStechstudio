...
import { BatteryMedium, Signal, Wifi, Smartphone, Cpu, Layers, Globe, Watch, SmartphoneNfc, Gamepad2, Code } from "lucide-react"
...
const mobileAppServices = [
  {
    ...
    icon: Cpu,
    description: "Our android app developers have proven expertise in developing robust Android applications for diverse business domains. We adhere to a user-centric approach for developing Android apps that helps businesses deliver services on the go."
  },
  {
    title: "iOS App Development",
    icon: Smartphone,
    description: "As a leading iOS app development agency, we create iOS and iPhone mobile apps that evolve with your business goals. Our iOS mobile solutions empower businesses to accelerate their digital transformation journey and achieve measurable outcomes."
  },
  {
    title: "Flutter App Development",
    icon: Layers,
    description: "Hire our Google-certified Flutter app developers to leverage the benefits of a single codebase for creating mobile apps for various platforms. Our experts create mobile apps with Flutter that deliver native-like app performance and experience to users."
  },
  {
    title: "PWA Development",
    icon: Globe,
    description: "Our progressive web app development services are aligned for seamlessly connecting businesses with their clients. We ensure your PWA is fast, secure, and optimized to deliver native-like experiences on both mobile and desktop platforms."
  },
  {
    title: "Wearable App Development",
    icon: Watch,
    description: "Our developers go beyond the limits of digital innovations to develop AI-powered wearable apps that transform health tracking into personalized insights. With a team of expert app developers, we create robust wearable apps that offer immersive design and intuitive app experience."
  },
  {
    title: "Cross-Platform App Development",
    icon: SmartphoneNfc,
    description: "We create seamless cross-platforms mobile apps through a single codebase that runs flawlessly on various platforms. Our cross-platform apps deliver native-like experiences on every platform, while ensuring significant cost savings."
  },
  {
    title: "Mobile Game Development",
    icon: Gamepad2,
    description: "We at TS Tech Studio are dedicated to delivering captivating and immersive mobile game app development services for both Android and iOS platforms. Our apps deliver an engaging user experience that attracts and retains gamers."
  },
  {
    title: "Native Mobile App Development",
    icon: Code,
    description: "Our native mobile app solutions offer optimized user experience with an easy-to-use interface and maximum security. Our team of native app development experts create bespoke solutions tailored to your business goals, for iOS and Android platforms."
  }
];
...
export function MobileAppAnimatedHero() {
  ...
  useGSAP(() => {
    ...
    const tl = gsap.timeline({
      ...
      tl.fromTo(trackWrapperRef.current, {
        scale: 0.7,
        opacity: 0,
        y: 100,
      }, {
    ...
    >
      ...
      >
        ...
        <p className="text-xl md:text-2xl text-white/60 font-medium max-w-2xl text-center leading-relaxed">
          ...
          <span className="text-white/40 mt-4 block">Scroll to experience our mobile capabilities.</span>
        </p>
      </div>
...
function UltraRealisticPhone({ service, index }: { service: typeof mobileAppServices[0], index: number }) {
  const themes = [
    { bg: "from-blue-500 to-indigo-600", accent: "bg-blue-500/20", shadow: "shadow-blue-500/20" },
    { bg: "from-purple-500 to-pink-600", accent: "bg-purple-500/20", shadow: "shadow-purple-500/20" },
    { bg: "from-emerald-400 to-teal-500", accent: "bg-emerald-500/20", shadow: "shadow-emerald-500/20" },
    { bg: "from-orange-400 to-red-500", accent: "bg-orange-500/20", shadow: "shadow-orange-500/20" },
  ...
  return (
    ...
    <div 
      className="ultra-phone-container relative shrink-0 flex items-center justify-center group transform-style-3d will-change-transform w-[260px] h-[530px]"
    >
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 transform scale-[0.75] origin-center flex items-center justify-center">
        ...
        <div className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[80%] h-[80%] bg-gradient-to-b ${t.bg} opacity-0 group-hover:opacity-40 transition-opacity duration-700 blur-[80px] -z-20 pointer-events-none`} />
            ...
            <div className="relative w-full h-full pt-20 px-5 pb-10 flex flex-col bg-gradient-to-b from-[#0a0a0a] to-[#000000] z-20">
              ...
              <div className="flex justify-between items-center mb-8">
                <div className="flex flex-col">
                  <span className="text-xs text-neutral-500 font-bold uppercase tracking-widest mb-1">Service {num}</span>
                  <h3 className={`text-2xl font-black text-transparent bg-clip-text bg-gradient-to-r ${t.bg} tracking-tight leading-none`}>
                    {service.title.split(' ')[0]} <br/> <span className="text-white">{service.title.substring(service.title.indexOf(' ') + 1)}</span>
                  </h3>
                </div>
                <div className={`w-12 h-12 rounded-2xl bg-gradient-to-br ${t.bg} flex items-center justify-center shadow-lg ${t.shadow} border border-white/20 shrink-0`}>
              ...
              <div className="relative flex-1 rounded-3xl bg-white/[0.03] border border-white/10 backdrop-blur-2xl p-6 flex flex-col shadow-2xl overflow-hidden group-hover:bg-white/[0.05] transition-colors duration-500">
                ...
                <div className={`absolute -top-10 -right-10 w-32 h-32 ${t.accent} rounded-full blur-[40px] pointer-events-none`} />
                ...
                <div className="relative z-10 flex flex-col h-full">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <span className="text-xs sm:text-sm font-semibold text-white/80">Premium Quality</span>
                  </div>
                  ...
                  <button className={`mt-4 w-full py-3 sm:py-4 rounded-xl sm:rounded-2xl bg-gradient-to-r ${t.bg} text-white text-xs sm:text-sm font-bold tracking-wide shadow-lg ${t.shadow} transform hover:scale-[1.02] transition-transform active:scale-[0.98]`}>
                    Explore Service
                  </button>
                </div>
              </div>
