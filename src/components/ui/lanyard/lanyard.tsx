...
function Band({
  ...
  const cardMap = useMemo(() => {
    ...
    // Fill the canvas with solid white first to completely overwrite any pre-baked background logo/graphics
...
// Preload the GLTF asset so it starts loading immediately
