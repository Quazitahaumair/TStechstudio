      ...
      <section className="relative min-h-[75vh] w-full pt-20 pb-16 px-4 md:px-8 lg:px-16 flex items-center justify-center">
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 lg:gap-8 items-center">
          ...
          <div className="flex flex-col items-start text-left space-y-6">
            ...
            >
              Data-led campaigns that put your brand in front of the right
              audience and drive measurable business results.
            </motion.p>
          ...
          <div className="relative w-full flex flex-col gap-6 lg:pl-10 mt-12 lg:mt-0">
            ...
            >
              ...
              <div className="flex items-center gap-2 mb-8">
                <span className="text-emerald-500 bg-emerald-50 px-2 py-0.5 rounded text-xs font-bold">↑ 28.6%</span>
              ...
              <div className="w-full h-32 relative">
                ...
                {/* SVG Line */}
                <svg viewBox="0 0 400 100" className="w-full h-full overflow-visible z-10 relative" preserveAspectRatio="none">
                  <defs>
            ...
            <div className="relative z-20 grid grid-cols-1 md:grid-cols-3 gap-4 w-full">
              ...
              >
                ...
                <svg viewBox="0 0 100 30" className="w-full h-8 overflow-visible" preserveAspectRatio="none">
                  <path d="M 0,25 L 20,15 L 40,20 L 60,5 L 80,10 L 100,0" fill="none" stroke="#3b82f6" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </motion.div>
              ...
              >
                ...
                <svg viewBox="0 0 100 30" className="w-full h-8 overflow-visible" preserveAspectRatio="none">
                  <path d="M 0,20 L 20,25 L 40,10 L 60,15 L 80,5 L 100,0" fill="none" stroke="#8b5cf6" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </motion.div>
              ...
              >
                ...
                <div className="flex items-center justify-between gap-2">
                  <div className="relative w-10 h-10 drop-shadow-sm shrink-0">
                    ...
                    <div className="absolute inset-0 rounded-full border-[4px] border-[#3b82f6]" style={{ clipPath: 'polygon(50% 50%, 100% 0, 100% 100%, 0 100%, 0 0, 50% 0)' }} />
                    <div className="absolute inset-0 rounded-full border-[4px] border-[#8b5cf6]" style={{ clipPath: 'polygon(50% 50%, 50% 0, 0 0, 0 50%)' }} />
                    <div className="absolute inset-0 rounded-full border-[4px] border-slate-200" style={{ clipPath: 'polygon(50% 50%, 0 50%, 0 100%, 50% 100%)' }} />
                  </div>
                  <div className="space-y-1 text-[8px] font-medium text-slate-600">
                    <div className="flex items-center gap-1"><div className="w-1.5 h-1.5 rounded-full bg-[#3b82f6] shadow-sm" /> Organic</div>
                    <div className="flex items-center gap-1"><div className="w-1.5 h-1.5 rounded-full bg-[#8b5cf6] shadow-sm" /> Paid</div>
                    <div className="flex items-center gap-1"><div className="w-1.5 h-1.5 rounded-full bg-slate-200 shadow-sm" /> Social</div>
                  </div>
                </div>
              </motion.div>
            </div>
            ...
            <motion.div animate={floatVariant(2)} className="absolute -top-6 -left-6 z-30 w-14 h-14 rounded-full bg-white/90 backdrop-blur-xl border border-white shadow-[0_10px_30px_-5px_rgba(59,130,246,0.3)] flex items-center justify-center text-slate-800">
              <span className="text-2xl font-extrabold bg-gradient-to-r from-blue-500 via-red-500 to-yellow-500 bg-clip-text text-transparent">G</span>
            </motion.div>
            
            <motion.div animate={floatVariant(2.5)} className="absolute top-[40%] -right-6 z-30 w-12 h-12 rounded-full bg-white/90 backdrop-blur-xl border border-white shadow-[0_10px_30px_-5px_rgba(59,130,246,0.3)] flex items-center justify-center">
              <span className="text-2xl font-extrabold text-[#3b82f6]">∞</span>
            </motion.div>

            <motion.div animate={floatVariant(3)} className="absolute -bottom-6 right-8 z-30 w-12 h-12 rounded-full bg-white/90 backdrop-blur-xl border border-white shadow-[0_10px_30px_-5px_rgba(236,72,153,0.3)] flex items-center justify-center">
              <Instagram className="size-5 text-pink-500 drop-shadow-sm" />
            </motion.div>

            <motion.div animate={floatVariant(1.2)} className="absolute top-[40%] -left-8 z-30 w-12 h-12 rounded-full bg-white/90 backdrop-blur-xl border border-white shadow-[0_10px_30px_-5px_rgba(59,130,246,0.3)] flex items-center justify-center text-[#3b82f6]">
              <span className="font-extrabold text-lg drop-shadow-sm">in</span>
            </motion.div>

            {/* Simulated 3D Megaphone */}
            <motion.div animate={floatVariant(0.8)} className="absolute -bottom-10 left-10 z-30 w-20 h-20 rounded-full bg-gradient-to-br from-blue-500/10 to-violet-500/10 backdrop-blur-2xl border border-white shadow-[0_15px_40px_-5px_rgba(59,130,246,0.3)] flex items-center justify-center">
              <Megaphone className="size-10 text-blue-600 rotate-[-15deg] drop-shadow-md" fill="currentColor" fillOpacity={0.2} />
            </motion.div>
      ...
      <section className="relative w-full py-24 px-4 md:px-8 lg:px-16 z-10 bg-white border-t border-slate-100">
        ...
        <div className="max-w-7xl mx-auto text-center mb-16">
          ...
          <p className="text-slate-500 max-w-2xl mx-auto text-lg font-medium">
            End-to-end digital marketing solutions focused on visibility,
