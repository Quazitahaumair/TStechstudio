    ...
    >
      ...
      <div
        ...
        style={{
          ...
          opacity: activeSection === 3 ? 0.4 : 0.85, // Use standard opacity instead of filter for mobile performance
        }}
      >
      ...
      {sections.map((section, index) => (
        ...
        >
          ...
          >
            ...
            {section.features && (
              <div className="grid gap-3 sm:gap-4 mb-8 sm:mb-10 lg:grid-cols-2">
              ...
              >
                {section.actions.map((action, actionIndex) => (
                  <button
                    ...
                    className={cn(
                      "group relative px-6 sm:px-8 py-3 sm:py-4 rounded-lg sm:rounded-xl font-medium transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] text-sm sm:text-base z-50",
                      "hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-primary/20 w-full sm:w-auto",
                      action.variant === "primary"
                        ? "bg-primary text-primary-foreground hover:bg-primary/90 shadow-lg shadow-primary/20 hover:shadow-primary/30 cursor-pointer"
                        : "border-2 border-border/60 bg-background/50 backdrop-blur-sm hover:bg-accent/50 hover:border-primary/30 text-foreground cursor-pointer",
                    )}
