        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex -space-x-2">
            <motion.div
              ...
              transition={{ delay: 1 }}
              className="w-8 h-8 rounded-full border-2 border-[#050505] bg-gradient-to-tr from-pink-500 to-orange-400 z-10"
            />
            <motion.div
              initial={{ x: 20, opacity: 0 }}
              animate={{ x: 0, opacity: 1 }}
              transition={{ delay: 1.2 }}
              className="w-8 h-8 rounded-full border-2 border-[#050505] bg-gradient-to-tr from-blue-500 to-emerald-400 z-0"
            />
          </div>
      ...
      <div className="flex-1 flex z-10 overflow-hidden relative">
        ...
        <div className="w-16 border-r border-white/5 bg-white/[0.01] backdrop-blur-md flex flex-col items-center py-6 gap-6 z-20 hidden md:flex">
          ...
          {[...Array(5)].map((_, i) => (
            <div
              key={i}
              className="w-8 h-8 rounded-lg border border-white/10 hover:bg-white/10 transition-colors flex items-center justify-center cursor-pointer"
            >
          ...
          >
            ...
            >
              <svg
                ...
                viewBox="0 0 24 36"
                fill="none"
                className="text-pink-500 drop-shadow-[0_0_10px_rgba(236,72,153,0.8)]"
              >
                <path
                ...
                <div className="flex flex-col gap-3 w-full">
                  {[...Array(6)].map((_, i) => (
                    ...
                    >
                      ...
                      <div
                        className={`h-2 rounded-full hidden md:block ${i === 1 ? "bg-blue-400 w-16" : "bg-white/20 w-20"}`}
                      />
                    </motion.div>
                  ))}
                </div>
                ...
                <div className="flex justify-between items-center border-b border-white/5 pb-6">
                  <div className="flex flex-col gap-2">
                    <motion.div
                      ...
                      className="h-6 bg-white/80 rounded-md overflow-hidden relative w-32 md:w-48"
                    >
        ...
        >
          <div className="flex justify-between items-center border-b border-white/10 pb-4">
            ...
            <div className="w-4 h-4 rounded-sm border border-white/20 flex items-center justify-center text-[8px] text-white/50">
              X
            </div>
          </div>
